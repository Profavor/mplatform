...
pub fn create_router(state: AppState) -> Router {
    ...
    Router::new()
        ...
        .route("/api/admin/integration/channels/smart-mapping-recommend", post(integration::smart_mapping_recommend))
        .route("/api/admin/integration/channels/:id", get(integration::get_channel_by_id).put(integration::update_channel).delete(integration::delete_channel))
        ...
        .route("/api/admin/integration/channels/:channel_id/metrics", get(integration::get_channel_metrics))
        .route("/api/admin/integration/channels/:channel_id/ping", post(integration::ping_channel))
