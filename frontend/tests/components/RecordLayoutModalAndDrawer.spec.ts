    ...
    const wrapper = mount(RecordLayoutBuilderModal, {
      ...
      global: {
        ...
        stubs: {
          ...
          VaModal: { template: '<div class="va-modal-stub"><slot/></div>' },
          'va-modal': { template: '<div class="va-modal-stub"><slot/></div>' },
          VaDropdown: { template: '<div class="va-dropdown-stub"><slot name="anchor"/><slot/></div>' },
          'va-dropdown': { template: '<div class="va-dropdown-stub"><slot name="anchor"/><slot/></div>' },
          vaDropdown: { template: '<div class="va-dropdown-stub"><slot name="anchor"/><slot/></div>' },
          VaDropdownContent: { template: '<div class="va-dropdown-content-stub"><slot/></div>' },
          'va-dropdown-content': { template: '<div class="va-dropdown-content-stub"><slot/></div>' },
          vaDropdownContent: { template: '<div class="va-dropdown-content-stub"><slot/></div>' },
          vaButton: true,
          'va-button': true,
          VaButton: true,
