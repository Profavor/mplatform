<template>
  <div style="display: flex; flex-direction: column; gap: 1.25rem; padding-bottom: 2rem;">
    <!-- Top Action Bar -->
    <div class="approvals-top-bar" style="display: flex; justify-content: space-between; align-items: center; background: var(--va-background-primary); padding: 1rem 1.25rem; border-radius: 12px; border: 1px solid var(--va-background-border); box-shadow: 0 2px 8px rgba(0,0,0,0.04);">
    ...
    <va-card style="border-radius: 12px; border: 1px solid var(--va-background-border); overflow: hidden;">
      <div class="approvals-card-header" style="padding: 0.85rem 1.25rem; border-bottom: 1px solid var(--va-background-border); display: flex; justify-content: space-between; align-items: center; background: var(--va-background-element);">
        ...
        <div class="approvals-header-actions" style="display: flex; gap: 0.5rem; align-items: center;">
...
/* Issue #250: Mobile responsive approvals toolbar */
@media (max-width: 768px) {
  ...
  .approvals-header-actions :deep(.va-button),
  .approvals-card-header :deep(.va-button),
  .approvals-card-header :deep(.va-chip) {
