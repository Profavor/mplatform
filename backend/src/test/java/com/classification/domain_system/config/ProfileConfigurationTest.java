...
class ProfileConfigurationTest {
    ...
    @Test
    @DisplayName("기본 application.yml의 ddl-auto는 위험한 update가 아닌 validate 혹은 none이어야 함 (Red)")
    void defaultApplicationYml_HasSafeDdlAuto() throws IOException {
        ...
        Object ddlAuto = source.getProperty("spring.jpa.hibernate.ddl-auto");
    ...
    @Test
    @DisplayName("운영 환경 application-prod.yml이 존재하며 ddl-auto가 validate로 명시되어 있어야 함 (Red)")
    ...
    @Test
    @DisplayName("개발 환경 application-dev.yml의 ddl-auto는 update로 유지되어야 함 (Green)")
