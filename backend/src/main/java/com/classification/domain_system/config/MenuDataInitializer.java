...
public class MenuDataInitializer {
    ...
    public void initMenus() {
        try {
            ...
            jdbcTemplate.update("INSERT INTO menu (name, path, icon, parent_id, sort_order, is_active, created_at, updated_at) VALUES ('{\"ko\":\"도메인 & 스키마 관리\",\"en\":\"Domain & Schema\"}', '/schema', 'schema', NULL, 2, TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)");
            jdbcTemplate.update("INSERT INTO menu (name, path, icon, parent_id, sort_order, is_active, created_at, updated_at) VALUES ('{\"ko\":\"마스터 데이터 관리\",\"en\":\"Master Data\"}', '/records', 'table_chart', NULL, 3, TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)");
            jdbcTemplate.update("INSERT INTO menu (name, path, icon, parent_id, sort_order, is_active, created_at, updated_at) VALUES ('{\"ko\":\"데이터 품질 관리\",\"en\":\"Data Quality\"}', '/dq-dashboard', 'insights', NULL, 4, TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)");
            jdbcTemplate.update("INSERT INTO menu (name, path, icon, parent_id, sort_order, is_active, created_at, updated_at) VALUES ('{\"ko\":\"결재 & 승인 관리\",\"en\":\"Approvals & Governance\"}', '/approvals', 'fact_check', NULL, 5, TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)");
            jdbcTemplate.update("INSERT INTO menu (name, path, icon, parent_id, sort_order, is_active, created_at, updated_at) VALUES ('{\"ko\":\"데이터 매칭 후보\",\"en\":\"Match Candidates\"}', '/match-candidates', 'find_replace', NULL, 6, TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)");
            ...
            // ── Admin sub-menus ──────────────────────────────────────────
            jdbcTemplate.update("INSERT INTO menu (name, path, icon, parent_id, sort_order, is_active, created_at, updated_at) VALUES ('{\"ko\":\"결재 진행 모니터링\",\"en\":\"Approval Monitor\"}', '/admin/approval-monitor', 'fact_check', ?, 1, TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)", adminId);
            jdbcTemplate.update("INSERT INTO menu (name, path, icon, parent_id, sort_order, is_active, created_at, updated_at) VALUES ('{\"ko\":\"조직 및 부서 관리\",\"en\":\"Organizations\"}', '/admin/organizations', 'corporate_fare', ?, 2, TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)", adminId);
            jdbcTemplate.update("INSERT INTO menu (name, path, icon, parent_id, sort_order, is_active, created_at, updated_at) VALUES ('{\"ko\":\"사용자 및 권한 관리\",\"en\":\"Users & Roles\"}', '/admin/users', 'group', ?, 3, TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)", adminId);
            ...
            jdbcTemplate.update("INSERT INTO menu (name, path, icon, parent_id, sort_order, is_active, created_at, updated_at) VALUES ('{\"ko\":\"시스템 로그\",\"en\":\"System Audit Logs\"}', '/admin/system-logs', 'receipt_long', ?, 5, TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)", adminId);
            ...
            jdbcTemplate.update("INSERT INTO menu (name, path, icon, parent_id, sort_order, is_active, created_at, updated_at) VALUES ('{\"ko\":\"워크플로우 관리\",\"en\":\"Workflow Config\"}', '/admin/workflow', 'account_tree', ?, 7, TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)", adminId);
            jdbcTemplate.update("INSERT INTO menu (name, path, icon, parent_id, sort_order, is_active, created_at, updated_at) VALUES ('{\"ko\":\"외부 연동 관리\",\"en\":\"Integration Channels\"}', '/admin/integration/channels', 'hub', ?, 8, TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)", adminId);
