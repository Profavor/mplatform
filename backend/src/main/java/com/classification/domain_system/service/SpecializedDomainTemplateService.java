    ...
    static {
        ...
        TEMPLATES.put("STOCK", SpecializedDomainTemplateDto.builder()
                ...
                .sectors(List.of(
                        ...
                        SectorTemplateDto.builder().code("CAPITAL_SHARES").name(Map.of("ko", "발행 및 자본금", "en", "Shares & Capitalization")).order(2)
                                .groups(List.of(
                                        ...
                                        FieldGroupTemplateDto.builder().code("LISTING_SCHEDULE_GROUP").name(Map.of("ko", "상장 일정 및 결산", "en", "Listing Date & Fiscal")).order(2).isDefaultOpen(true).build()
                                )).build(),
                        SectorTemplateDto.builder().code("TRADING_GOVERNANCE").name(Map.of("ko", "매매 및 관리 종목", "en", "Trading & Governance")).order(3)
                                .groups(List.of(
                ...
                .fields(List.of(
                        ...
                        FieldTemplateDto.builder().key("listing_date").groupCode("LISTING_SCHEDULE_GROUP").name(Map.of("ko", "최초 상장일자", "en", "Listing Date")).type("DATE").required(false).isGridVisible(true).gridWidth(3).tableColumnWidth(130).order(12).build(),
                        FieldTemplateDto.builder().key("fiscal_month").groupCode("LISTING_SCHEDULE_GROUP").name(Map.of("ko", "결산월", "en", "Fiscal Month")).type("SELECT").required(false).isGridVisible(true).gridWidth(2).tableColumnWidth(110).order(13)
                        ...
                        FieldTemplateDto.builder().key("is_trading_halt").groupCode("TRADING_HALT_GROUP").name(Map.of("ko", "거래정지 여부", "en", "Is Trading Halt")).type("BOOLEAN").required(false).isFilterable(true).isGridVisible(true).gridWidth(2).tableColumnWidth(120).order(14).build(),
                        FieldTemplateDto.builder().key("is_delisting_risk").groupCode("TRADING_HALT_GROUP").name(Map.of("ko", "관리/투자주의 종목", "en", "Delisting Risk")).type("BOOLEAN").required(false).isFilterable(true).isGridVisible(true).gridWidth(2).tableColumnWidth(130).order(15).build(),
                        FieldTemplateDto.builder().key("transfer_agent").groupCode("TRADING_HALT_GROUP").name(Map.of("ko", "명의개서대행기관", "en", "Transfer Agent")).type("SELECT").required(false).isGridVisible(true).gridWidth(3).tableColumnWidth(150).order(16)
                        ...
                        FieldTemplateDto.builder().key("settlement_cycle").groupCode("TRADING_HALT_GROUP").name(Map.of("ko", "결제주기", "en", "Settlement Cycle")).type("SELECT").required(false).isGridVisible(true).gridWidth(2).tableColumnWidth(120).order(17)
