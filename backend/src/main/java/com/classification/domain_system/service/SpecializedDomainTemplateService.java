    ...
    static {
        ...
        TEMPLATES.put("STOCK", SpecializedDomainTemplateDto.builder()
                ...
                .sectors(List.of(
                        ...
                        SectorTemplateDto.builder().code("CAPITAL_SHARES").name(Map.of("ko", "발행 및 자본금", "en", "Shares & Capitalization")).order(2)
                                .groups(List.of(
                                        ...
                                        FieldGroupTemplateDto.builder().code("PRICE_VALUATION_GROUP").name(Map.of("ko", "기준 시세 및 거래 동향", "en", "Price & Market Trading")).order(2).isDefaultOpen(true).build(),
                        ...
                        SectorTemplateDto.builder().code("FINANCIAL_VALUATION").name(Map.of("ko", "투자 가치 및 배당 지표", "en", "Valuation & Dividends")).order(3)
                                .groups(List.of(
                                        FieldGroupTemplateDto.builder().code("VALUATION_GROUP").name(Map.of("ko", "가치평가 및 수익성 지표", "en", "Valuation Metrics")).order(1).isDefaultOpen(true).build(),
                                        FieldGroupTemplateDto.builder().code("DIVIDEND_GROUP").name(Map.of("ko", "배당 수익 및 배당일정", "en", "Dividend Information")).order(2).isDefaultOpen(true).build()
                                )).build(),
                ...
                .fields(List.of(
                        ...
                        FieldTemplateDto.builder().key("market_type").groupCode("MARKET_SECTOR_GROUP").name(Map.of("ko", "상장 시장", "en", "Market Type")).type("SELECT").required(true).isFilterable(true).isGridVisible(true).gridWidth(3).tableColumnWidth(130).order(6)
                        ...
                        FieldTemplateDto.builder().key("industry_sector").groupCode("MARKET_SECTOR_GROUP").name(Map.of("ko", "업종/섹터 (WICS)", "en", "Industry Sector")).type("TEXT").required(false).isFilterable(true).isGridVisible(true).gridWidth(3).tableColumnWidth(150).order(7).build(),
                        ...
                        FieldTemplateDto.builder().key("current_price").groupCode("PRICE_VALUATION_GROUP").name(Map.of("ko", "최근 기준가/종가", "en", "Current/Close Price")).type("NUMBER").required(false).isGridVisible(true).gridWidth(3).tableColumnWidth(140).order(13).build(),
                        FieldTemplateDto.builder().key("previous_close_price").groupCode("PRICE_VALUATION_GROUP").name(Map.of("ko", "전일 종가", "en", "Previous Close Price")).type("NUMBER").required(false).isGridVisible(false).gridWidth(3).tableColumnWidth(130).order(14).build(),
                        FieldTemplateDto.builder().key("open_price").groupCode("PRICE_VALUATION_GROUP").name(Map.of("ko", "당일 시가", "en", "Open Price")).type("NUMBER").required(false).isGridVisible(false).gridWidth(3).tableColumnWidth(130).order(15).build(),
                        FieldTemplateDto.builder().key("high_price").groupCode("PRICE_VALUATION_GROUP").name(Map.of("ko", "당일 고가", "en", "High Price")).type("NUMBER").required(false).isGridVisible(false).gridWidth(3).tableColumnWidth(130).order(16).build(),
                        FieldTemplateDto.builder().key("low_price").groupCode("PRICE_VALUATION_GROUP").name(Map.of("ko", "당일 저가", "en", "Low Price")).type("NUMBER").required(false).isGridVisible(false).gridWidth(3).tableColumnWidth(130).order(17).build(),
                        FieldTemplateDto.builder().key("change_price").groupCode("PRICE_VALUATION_GROUP").name(Map.of("ko", "전일대비 변동가", "en", "Change Price")).type("NUMBER").required(false).isGridVisible(false).gridWidth(3).tableColumnWidth(130).order(18).build(),
                        FieldTemplateDto.builder().key("fluctuation_rate").groupCode("PRICE_VALUATION_GROUP").name(Map.of("ko", "전일대비 등락률(%)", "en", "Fluctuation Rate (%)")).type("NUMBER").unit("%").required(false).isGridVisible(true).gridWidth(2).tableColumnWidth(130).order(19).build(),
                        FieldTemplateDto.builder().key("accumulated_trading_volume").groupCode("PRICE_VALUATION_GROUP").name(Map.of("ko", "누적 거래량", "en", "Trading Volume")).type("NUMBER").unit("Shares").required(false).isGridVisible(true).gridWidth(3).tableColumnWidth(150).order(20).build(),
                        FieldTemplateDto.builder().key("accumulated_trading_value").groupCode("PRICE_VALUATION_GROUP").name(Map.of("ko", "누적 거래대금", "en", "Trading Value")).type("NUMBER").unit("KRW").required(false).isGridVisible(false).gridWidth(3).tableColumnWidth(160).order(21).build(),
                        FieldTemplateDto.builder().key("market_cap").groupCode("PRICE_VALUATION_GROUP").name(Map.of("ko", "시가총액", "en", "Market Capitalization")).type("NUMBER").required(false).isGridVisible(true).gridWidth(3).tableColumnWidth(160).order(22).build(),
                        FieldTemplateDto.builder().key("week52_high").groupCode("PRICE_VALUATION_GROUP").name(Map.of("ko", "52주 최고가", "en", "52-Week High")).type("NUMBER").required(false).isGridVisible(false).gridWidth(3).tableColumnWidth(130).order(23).build(),
                        FieldTemplateDto.builder().key("week52_low").groupCode("PRICE_VALUATION_GROUP").name(Map.of("ko", "52주 최저가", "en", "52-Week Low")).type("NUMBER").required(false).isGridVisible(false).gridWidth(3).tableColumnWidth(130).order(24).build(),
                        FieldTemplateDto.builder().key("price_base_date").groupCode("PRICE_VALUATION_GROUP").name(Map.of("ko", "시세 기준일자", "en", "Price Base Date")).type("DATE").required(false).isGridVisible(true).gridWidth(3).tableColumnWidth(130).order(25).build(),
